...
export default function ProductCard({
    ...
    return (
        <div className="flex flex-col h-full group relative bg-card rounded-lg overflow-hidden shadow-card hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1 animate-fade-in">
            {badge && (
                <Badge
